...
const AllTrades = () => {
  ...
  const filteredTrades = trades.filter((trade) => {
    ...
    if (filterBookName.length > 0 && !filterBookName.includes(trade.bookName)) {
      return false;
    }
      ...
      {showFilters && (
        ...
        >
          ...
          <div className="filter-container">
            ...
            <select
              value={filterTradeCurrency}
              onChange={(e) => setFilterTradeCurrency(e.target.value)}
            >
              <option value="">All</option>
          ...
          <div className="filter-container">
            ...
            <select
              value={filterBondHolder}
              onChange={(e) => setFilterBondHolder(e.target.value)}
            >
              <option value="">All</option>
          ...
          <div className="filter-container">
            ...
            <select
              ...
              onChange={(e) => setFilterTradeStatus(e.target.value)}
            >
              <option value="">All</option>
            ...
            <select
              ...
              onChange={(e) => {
                ...
                if (selectedValues.includes("")) {
                  ...
                  setFilterBookName(selectedValues);
                }
              }}
            >
              <option value="">All</option>
